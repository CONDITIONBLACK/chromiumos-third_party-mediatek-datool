...
static int download_download_agent(tty_usb_handle *h, int is_brom, char *auth_path, char *pl_path,
        char *lk_path, CHIP_DATA *chip)
{
    int r;
...
int main(int argc, char *argv[])
{
    ...
    if (download_download_agent(h, is_brom, auth_path, pl_path, lk_path, chip) != 0) {
